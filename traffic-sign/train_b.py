...
from keras.layers import Conv2D, MaxPooling2D, Dropout, Flatten, Input
import cv2
...
def myModel():
    ...
    model = Sequential([
        Input(shape=(imageDimesions[0], imageDimesions[1], 1)),
        Conv2D(no_Of_Filters, size_of_Filter, activation='relu'),
        Conv2D(no_Of_Filters, size_of_Filter, activation='relu'),
